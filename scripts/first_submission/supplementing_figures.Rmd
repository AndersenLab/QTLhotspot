...
for (i in 1:length(dosedrugs)) {
        ...
        traitdf$trait <- factor(traitdf$trait, levels = c("norm.n","q25.TOF","q75.TOF"), labels = c("Brood Size", "Small Size", "Large Size"))
        ...
        doseplot <- ggplot2::ggplot(traitdf) +
          ...
          ggplot2::labs(x = "Concentration (µM)", y = "Residual phenotype") +
          ...
          ggplot2::theme(axis.text.x = ggplot2::element_text(size=10, face = "bold", color="black"),
            ...
            traitcor <- splitbydose[[i]] %>%
              dplyr::filter(trait %in% c("n","norm.n", "q10.TOF", "q10.EXT", "q25.TOF", "q25.EXT", "median.TOF", "median.EXT", "mean.TOF", "mean.EXT", "q75.TOF",
                                         "q75.EXT", "q90.TOF", "q90.EXT", "var.TOF", "var.EXT", "q10.norm.EXT", "q25.norm.EXT", "median.norm.EXT", "mean.norm.EXT",
            ...
            traitcor$trait <- factor(traitcor$trait, levels = c("n","norm.n", "q10.TOF", "q10.EXT", "q25.TOF", "q25.EXT", "median.TOF", "median.EXT", "mean.TOF",
                                                                "mean.EXT", "q75.TOF", "q75.EXT", "q90.TOF", "q90.EXT", "var.TOF", "var.EXT", "q10.norm.EXT",
