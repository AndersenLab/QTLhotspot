...
```{r fig1, fig.width=7.5, fig.height=7.5,warning=F, message=F, echo=F,comment="K",results='asis', dpi = 300}
...
threetrait <- uniqueQTL %>%
    ...
    mutate(class = NA, marker = NA) %>%
    select(chr, pos, condition, trait, lod, ci_l_pos, ci_r_pos, class)
...
ourcolors <- topo.colors(15)[1:11]
#Plot
unique_all <- ggplot(threetrait)+
    aes(x=pos/1E6, y=trait)+
    theme_bw() +
    scale_fill_gradientn(name = "LOD", colours = ourcolors, values = c(0, .01, .05, .1, .15, .2, .25, .3, .4, .5, .6, .7, .8, .9, 1))+
    scale_color_gradientn(name = "LOD", colours =ourcolors, values = c(0, .01, .05, .1, .15, .2, .25, .3, .4, .5, .6, .7, .8, .9, 1))+
...
```{r fig2, fig.width=7.5, fig.height=3,warning=F, message=F, echo=F,comment="K",results='asis', dpi = 300}
...
fig2 <- plot_grid(narrow_broad, narrow_VE, labels = c("A", "B"), nrow = 1, ncol =2, rel_widths = c(1, 1.4))
fig2
...
```{r fig3, fig.width=7.5, fig.height=2.5,warning=F, message=F, echo=F,comment="K",results='asis', dpi = 300}
...
```{r fig4, fig.width=7.5, fig.height=10,warning=F, message=F, echo=F,comment="K",results='asis', dpi = 300}
