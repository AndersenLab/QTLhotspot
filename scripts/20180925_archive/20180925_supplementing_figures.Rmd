...
source_data("https://github.com/AndersenLab/QTLhotspot/blob/master/data/FileS4_allRIAILsPC.Rda?raw=TRUE")
source_data("https://github.com/AndersenLab/QTLhotspot/blob/master/data/FileS5_allAnnotatedLodsPC.Rda?raw=TRUE")
source_data("https://github.com/AndersenLab/QTLhotspot/blob/master/data/FileS6_scantwosummary.Rda?raw=TRUE")
source_data("https://github.com/AndersenLab/QTLhotspot/blob/master/data/FileS7_varianceComponents.Rda?raw=TRUE")
source_data("https://github.com/AndersenLab/QTLhotspot/blob/master/data/FileS9_PC_trait_correlation.Rda?raw=TRUE")
...
```{r s2_2,fig.width=7.5, fig.height=6,warning=F, message=F, echo=F,comment="K",results='asis', dpi = 300}
...
for(drug in unique(splitmap$condition)) {
    ...
    for(trt in unique(drugmap$trait)) {
        ...
        # print figures
        print(cowplot::plot_grid(lod, ril_plots, nrow = 2, ncol = 1, labels = c("A", "B")))
...
```{r s4_2,fig.width=7.5, fig.height=6,warning=F, message=F, echo=F,comment="K",results='asis', dpi = 300}
...
for(drug in unique(splitmap$condition)) {
    ...
    for(trt in unique(drugmap$trait)) {
        ...
        # make blank plots up to 5 for RIAIL phenotype split so they are all even
        ril <- pxgplot_kt(phenocross, allAnnotatedLodsPC %>% dplyr::filter(trait == paste0(drug, ".", trt)))
